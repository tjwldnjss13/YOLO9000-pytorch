...
class VOCDataset(data.Dataset):
    def __init__(self, root, is_validation=False, valid_split=.3, transforms=None, to_categorical=True, get_bbox_only=False):
        self.root = root
        self.is_validation = is_validation
        self.valid_split = valid_split
        self.transforms = transforms
        self.to_categorical = to_categorical
        self.get_bbox_only = get_bbox_only
